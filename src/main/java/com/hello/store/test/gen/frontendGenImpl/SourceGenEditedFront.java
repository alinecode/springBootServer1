...
// */
//public class SourceGenEditedFront {
...
//
//	public SourceGenEditedFront(SQLManager sm, String table, String pkg, String srcPath, GenConfig config,@NotBlank String className) {
